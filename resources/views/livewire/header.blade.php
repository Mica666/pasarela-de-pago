...
<nav>
       <div class="dark:bg-red-100/70">
<div class="  mx-auto  max-w-7xl px-2 sm:px-6 lg:px-8">
       <br>
       <div class="grid grid-cols-10">

                     
              <div class="col-span-6 text text-right">
                     <span class="text-5xl leading-7 font-bold  text-red-900">Tickets Universe</span>
              </div>

             
              <div class="flex absolute top-6 right-20 space-x-6  col-span-3  ">
                     <div class="text-sl  leading-7 pt-1 text-red-900 font-bold ">Sábado 14 de Enero de 2023</div>
