...
<nav class="dark:bg-red-600/90 backdrop-blur-sm  z-50 bg-fixed hover:bg-top" x-data="{open:false}">
 ...
 --> <!-- menu -->
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              <a href="/" class="bg-neutral-900 text-white px-3 py-2 rounded-md text-sm font-medium" >Inicio</a>
